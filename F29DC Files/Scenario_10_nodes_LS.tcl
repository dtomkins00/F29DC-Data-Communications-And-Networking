#Code to simulate a network with a mesh topology of 10 nodes using the Link State (LS) protocol
#By Drew Tomkins
...
set nf [open Scenario_10_nodes_LS.nam w]
$ns namtrace-all $nf

#Open the trace file
set tf [open Scenario_10_nodes_LS.tr w]
$ns trace-all $tf
...
proc finish {} {
	...
	#Execute nam on the trace file
        exec nam Scenario_10_nodes_LS.nam &
        exit 0
}
