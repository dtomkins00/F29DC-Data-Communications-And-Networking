#Code to simulate a network with a mesh topology of 20 nodes using the Distance Vector (DV) protocol
#By Drew Tomkins
...
set nf [open Scenario_20_nodes_DV.nam w]
$ns namtrace-all $nf

#Open the trace file
set tf [open Scenario_20_nodes_DV.tr w]
$ns trace-all $tf
...
proc finish {} {
	...
	#Execute nam on the trace file
        exec nam Scenario_20_nodes_DV.nam &
        exit 0
}
