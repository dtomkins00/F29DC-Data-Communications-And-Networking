...
set nf [open Scenario_10_nodes_DV.nam w]
$ns namtrace-all $nf

#Open the trace file
set tf [open Scenario_10_nodes_DV.tr w]
$ns trace-all $tf

#Use a for loop to set up ten nodes
...
#Schedules when the specified links go down
$ns rtmodel-at 1.0 down $n(0) $n(5)
$ns rtmodel-at 1.5 down $n(3) $n(5)
$ns rtmodel-at 2.0 down $n(0) $n(9)

#Schedules when the specified links go up
$ns rtmodel-at 4.0 up $n(0) $n(9)
$ns rtmodel-at 4.5 up $n(3) $n(5)
$ns rtmodel-at 5.0 up $n(0) $n(5)
...
proc finish {} {
	...
	#Execute nam on the trace file
        exec nam Scenario_10_nodes_DV.nam &
        exit 0
}
